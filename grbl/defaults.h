...
#define DEFAULT_SPINDLE_RPM_MIN 0.0f // rpm
#define DEFAULT_STEP_PULSE_MICROSECONDS 10
#define DEFAULT_STEPPING_INVERT_MASK 7//步进端口反转，掩码
#define DEFAULT_DIRECTION_INVERT_MASK 7//方向端口反转，掩模
#define DEFAULT_STEPPER_IDLE_LOCK_TIME 0 // msec (0-254, 255 keeps steppers enabled)
#define DEFAULT_STATUS_REPORT_MASK 1 // MPos enabled
#define DEFAULT_JUNCTION_DEVIATION 0.01f //结点偏差，毫米
#define DEFAULT_ARC_TOLERANCE 0.002f //圆弧公差，mm
#define DEFAULT_REPORT_INCHES 0 // false
#define DEFAULT_INVERT_ST_ENABLE 0 // false
#define DEFAULT_INVERT_LIMIT_PINS 0 // false
#define DEFAULT_SOFT_LIMIT_ENABLE 0 // false软限制
#define DEFAULT_HARD_LIMIT_ENABLE 0  // false硬限制
#define DEFAULT_INVERT_PROBE_PIN 0 // false
#define DEFAULT_LASER_MODE 0 // false
#define DEFAULT_HOMING_ENABLE 1  // false
#define DEFAULT_HOMING_DIR_MASK 3 // move positive dir
#define DEFAULT_HOMING_FEED_RATE 25.0f // mm/min 归位进给
#define DEFAULT_HOMING_SEEK_RATE 500.0f // mm/min 归位搜索速率
#define DEFAULT_HOMING_DEBOUNCE_DELAY 250 // msec (0-65k)
